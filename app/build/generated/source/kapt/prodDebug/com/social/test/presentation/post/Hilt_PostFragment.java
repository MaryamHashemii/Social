...
public abstract class Hilt_PostFragment<T extends ViewDataBinding> extends ObserverDataBindingFragment<T> implements GeneratedComponentManagerHolder {
  ...
  Hilt_PostFragment(int layoutRes) {
    super(layoutRes);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PostFragment_GeneratedInjector) this.generatedComponent()).injectPostFragment(UnsafeCasts.<PostFragment>unsafeCast(this));
    }
  }
