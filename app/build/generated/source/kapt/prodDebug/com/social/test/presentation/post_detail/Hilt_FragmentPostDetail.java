...
public abstract class Hilt_FragmentPostDetail<T extends ViewDataBinding> extends ObserverDataBindingFragment<T> implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentPostDetail(int layoutRes) {
    super(layoutRes);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentPostDetail_GeneratedInjector) this.generatedComponent()).injectFragmentPostDetail(UnsafeCasts.<FragmentPostDetail>unsafeCast(this));
    }
  }
