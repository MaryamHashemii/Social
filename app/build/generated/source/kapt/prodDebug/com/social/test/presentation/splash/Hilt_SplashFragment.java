...
public abstract class Hilt_SplashFragment<T extends ViewDataBinding> extends BaseDataBindingFragment<T> implements GeneratedComponentManagerHolder {
  ...
  Hilt_SplashFragment(int layoutRes) {
    super(layoutRes);
  }
